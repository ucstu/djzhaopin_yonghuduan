<template>
  <view class="flex-col component">
    <CompanyDetail @click="view_4OnClick" :companyDetail="attentionCompany" />
    <view class="flex-row group_4">
      <view class="flex-col items-center text-wrapper_1">
        <text>{{ func }}</text>
      </view>
      <view @click="view_10OnClick" class="flex-col items-center image-wrapper">
        <image
...
<style lang="scss" scoped>.component {
  padding-top: 23rpx;
  border-radius: 5rpx;
  overflow: hidden;
  height: 235rpx;
